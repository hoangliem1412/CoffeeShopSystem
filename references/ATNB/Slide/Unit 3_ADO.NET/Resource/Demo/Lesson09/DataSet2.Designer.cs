...
namespace Lesson09.DataSet2TableAdapters {
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        Description, Picture, CategoryID\r\nFROM            Categories\r\nWHERE" +
                "        (CategoryID = @id)";
        ...
        public virtual int FillBy(DataSet2.CategoriesDataTable dataTable, int id) {
        ...
        public virtual DataSet2.CategoriesDataTable GetDataBy(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            DataSet2.CategoriesDataTable dataTable = new DataSet2.CategoriesDataTable();
            this.Adapter.Fill(dataTable);
