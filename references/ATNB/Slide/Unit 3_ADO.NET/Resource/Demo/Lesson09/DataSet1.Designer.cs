...
namespace Lesson09.DataSet1TableAdapters {
...
SELECT OrderID, CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDate, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry FROM Orders WHERE (OrderID = SCOPE_IDENTITY())";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lesson09.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT        OrderID, CustomerID, EmployeeID, Freight, ShipName, ShipCountry\r\nFR" +
        ...
        public virtual int FillBy(DataSet1.OrdersDataTable dataTable, global::System.Nullable<int> EmployeeID) {
        ...
        public virtual DataSet1.OrdersDataTable GetDataBy(global::System.Nullable<int> EmployeeID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((EmployeeID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(EmployeeID.Value));
            }
