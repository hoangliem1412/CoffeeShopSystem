...
//Advanced search
$("#SexSearch").change(function () {
    var selectedGender = this.value;
    var selectedRole = $("#RoleSearch").val();
    mainTable.column('6').search(selectedRole).draw();
    mainTable.column('5').search(selectedGender).draw();
});
$("#RoleSearch").change(function () {
    var selectedRole = this.value;
    var selectedGender = $("#SexSearch").val();
    mainTable.column('5').search(selectedGender).draw();
    mainTable.column('6').search(selectedRole).draw();
});
...
$('#SubmitEdit').on('click', function () {
    ...
    if (editform.valid() == true) {
        ...
        .done(function (result) {
            ...
            mainTable.cell(row, 5).data(result.Sex).draw(false);
            mainTable.cell(row, 6).data(result.Role).draw(false);
