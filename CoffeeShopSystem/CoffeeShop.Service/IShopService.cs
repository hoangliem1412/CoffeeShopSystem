...
public interface IShopService
{
    ...
    IEnumerable<Shop> GetAllNonDeleteWithPaginationAndSort(string sort, string type, out int total, int curPage, int pageSize);


    IEnumerable<Shop> GetAllDeleted();
    IEnumerable<Shop> GetAllDeletedWithPaginationAndSort(string sort, string type, out int total, int curPage, int pageSize);
